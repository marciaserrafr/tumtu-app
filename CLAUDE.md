...
🚧 Pendências conhecidas (não urgentes, todas confirmadas como pós-piloto em 17/jul/2026): Apagar a tabela antiga `ritmistas` (risco confirmado baixo — só 2 das 28 linhas são reais, já migradas corretamente; falta só o "pode apagar" final dela). Aba "Bateria" do Super Admin tem um campo antigo "Mestre de Bateria" (texto livre, desconectado do sistema real de vínculos) que confunde. Cadastro de temporadas com histórico e interruptor pra ritmista editar as próprias medidas — 2 ideias registradas, nenhuma desenhada ainda.
