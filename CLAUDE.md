...
🚧 **Da revisão de segurança de 18/jul/2026, ainda falta:** não existe UI pra trocar o cargo de alguém (ex: promover Ritmista pra Diretor da mesma bateria) — nem Super Admin tem essa opção na tela (`super-admin.html` mostra o campo "Perfil" desabilitado); só é possível hoje via SQL direto, sob pedido dela.
