...
> Última atualização: 01/set/2026 (bug do botão Presença sem evento ativo corrigido e publicado; permissão de Convidados corrigida pra ser genérica — pronta no código, pendente só de banco)
