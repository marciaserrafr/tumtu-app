...
Já com a reforma em produção, ela pediu uma melhoria geral (não só pro item novo de Naipe, ver 62.13): "se ver ritmistas não estiver marcado, não é nem para liberar essa marcação, ela deveria ficar desabilitada" — e generalizou: "a mesma coisa é: se uma pessoa não pode ver a tela ritmistas, então ela não pode editar."
