const CACHE_NAME = 'tumtu-shell-v124';
...
const APP_SHELL = [
  ...
  './ficha-perfil.js?v=16',
  './ficha-perfil.partial.html?v=16',
  './config-escola.js?v=2',
  './config-suporte.js?v=1',
  './manifest.json',
  './styles/tokens.css?v=4',
  './styles/components.css?v=14',
  './styles/carteirinha-tumtu-novo.css?v=33',
  './icons/icon-192.png',
  './icons/icon-512.png',
];
